 ...
 */
public class OldDogViewHolder extends BaseViewHolder<Dog>{
     ...
     */
    public OldDogViewHolder(Context context, ViewGroup root) {
        super(context, root, R.layout.item_layout_dog_old);
    }
